...
backup_user: "{{ ansible_facts['env']['SUDO_USER'] | default(ansible_facts['env']['USER'], true) | default(ansible_facts['user_id'], true) }}"
backup_group: "{{ ansible_facts['env']['SUDO_GROUP'] | default(ansible_facts['env']['GROUP'], true) | default(ansible_facts['user_gid'], true) }}"
